...
const services: Array<ServiceCandidate & { patterns: RegExp[] }> = [
  {
    ...
    name: "Plumbing",
    patterns: [
      /\b(plumb|tap|faucet|toilet|basin|sink|pipe|drain|geyser|shower|bath|water leak|blocked drain)\w*\b/i,
    ],
  },
  {
    key: "electrical",
    name: "Electrical",
    patterns: [
      /\b(electric|socket|plug point|light switch|light fitting|wiring|db board|circuit breaker|power trip)\w*\b/i,
    ],
  },
  {
    key: "carpentry",
    name: "Carpentry",
    patterns: [
      /\b(carpent|cupboard|cabinet|wooden door|woodwork|timber|shel(?:f|ves))\w*\b/i,
    ],
  },
  {
    key: "painting",
    name: "Painting",
    patterns: [/\b(paint|repaint|wall colour|peeling wall)\w*\b/i],
  },
  {
    key: "roofing",
    name: "Roofing",
    patterns: [/\b(roof|roof tile|roof leak)\w*\b/i],
  },
  {
    key: "appliance",
    name: "Appliance Repair",
    patterns: [
      /\b(fridge|freezer|stove|oven|washing machine|dishwasher|tumble dryer|appliance)\w*\b/i,
    ],
  },
  {
    key: "locksmith",
    name: "Locksmith",
    patterns: [/\b(locksmith|door lock|padlock|lost key|broken key)\w*\b/i],
  },
  { key: "tiling", name: "Tiling", patterns: [/\b(tile|tiling|grout)\w*\b/i] },
  {
    key: "waterproofing",
    name: "Waterproofing",
    patterns: [/\b(waterproof|rising damp|damp wall)\w*\b/i],
  },
  {
    key: "paving",
    name: "Paving",
    patterns: [/\b(paving|paver|driveway brick)\w*\b/i],
  },
  {
    key: "gardening",
    name: "Gardening & Landscaping",
    patterns: [
      /\b(garden|landscap|grass|lawn|hedge|tree trimming|weeding)\w*\b/i,
    ],
  },
  {
    key: "pool",
    name: "Pool Maintenance",
    patterns: [/\b(swimming pool|pool pump|pool filter|pool cleaning)\w*\b/i],
  },
  {
    key: "hvac",
    name: "Air Conditioning & HVAC",
    patterns: [/\b(air ?con|air conditioning|hvac)\w*\b/i],
  },
  {
    key: "welding",
    name: "Welding & Metalwork",
    patterns: [/\b(weld|metalwork|steel fabrication)\w*\b/i],
  },
  {
    key: "glass",
    name: "Windows & Glass",
    patterns: [/\b(window glass|broken window|glaz|glass pane)\w*\b/i],
  },
  {
    key: "drywall",
    name: "Ceilings & Drywall",
    patterns: [/\b(ceiling|drywall|plasterboard)\w*\b/i],
  },
  {
    key: "flooring",
    name: "Flooring",
    patterns: [/\b(laminate floor|wooden floor|vinyl floor|flooring)\w*\b/i],
  },
  { key: "gutters", name: "Gutters", patterns: [/\b(gutter|downpipe)\w*\b/i] },
  {
    key: "solar",
    name: "Solar & Inverter",
    patterns: [/\b(solar panel|inverter|battery backup)\w*\b/i],
  },
  {
    key: "security",
    name: "CCTV & Security",
    patterns: [/\b(cctv|security camera|alarm system|intercom)\w*\b/i],
  },
  {
    key: "garage",
    name: "Gates & Garage Doors",
    patterns: [/\b(garage door|gate motor|electric gate|sliding gate)\w*\b/i],
  },
  {
    key: "pest",
    name: "Pest Control",
    patterns: [
      /\b(pest|cockroach|termite|bedbug|bed bug|rat infestation|ant infestation)\w*\b/i,
    ],
  },
  {
    key: "furniture",
    ...
    patterns: [
      /\b(flatpack|furniture assembly|assemble (?:a )?(?:bed|desk|table|wardrobe))\w*\b/i,
    ],
  },
  {
    key: "moving",
    name: "Small Moves & Heavy Lifting",
    patterns: [
      /\b(move furniture|heavy lifting|small move|move (?:a )?(?:sofa|couch|bed|fridge))\w*\b/i,
    ],
  },
];
...
export function classifyService(description: string): ServiceClassification {
  ...
  for (const service of services) {
    if (service.patterns.some((pattern) => pattern.test(value))) {
      return {
        scope: "supported",
        candidate: { key: service.key, name: service.name },
      };
    }
  }
...
export const unclearServiceReply = {
  handled: true,
  reply:
    "I couldn’t identify a supported home service yet. Name the household item and problem—for example, ‘leaking toilet’, ‘broken socket’ or ‘paint my bedroom wall’.",
};
